...
import {
  to = module.preview.module.cg-logshipper.module.s3-logshipper-storage.cloudfoundry_service_instance.bucket
  id = "c65050a7-fbba-4e27-8e69-0163835f17e3"
}

import {
  to = module.preview.module.fac-file-scanner.module.quarantine.cloudfoundry_service_instance.bucket
  id = "5cef0c0b-1e68-451a-8e32-bc175a491bfa"
}
