...
def generate_workbooks(dbkey, outdir):
    fat = generate_federal_awards(dbkey, outdir)
    ft = generate_findings(dbkey, outdir)
    ftt = generate_findings_text(dbkey, outdir)
    aut = generate_additional_ueis(dbkey, outdir)
    ntst = generate_notes_to_sefa(dbkey, outdir)
    sat = generate_secondary_auditors(dbkey, outdir)
    ctt = generate_captext(dbkey, outdir)
