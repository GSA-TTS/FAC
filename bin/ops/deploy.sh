...
echo cf push -f backend/manifests/manifest-fac.yml -t 180 --vars-file backend/manifests/vars/vars-"${cfspace}".yml --strategy rolling
cf push -f backend/manifests/manifest-fac.yml -t 180 --vars-file backend/manifests/vars/vars-"${cfspace}".yml --strategy rolling
