...
from dissemination.workbooklib.sac_creation import (
...
from dissemination.workbooklib.federal_awards import generate_federal_awards
...
filenames = {
    ...
    FORM_SECTIONS.FEDERAL_AWARDS: "federal-awards-{}.xlsx",
