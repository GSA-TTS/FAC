...
def _search_post_helper(request, is_advanced):
    """
    Helper for handling basic and advanced search POST requests
    """
    ...
    form_data["advanced_search_flag"] = is_advanced
    ...
    context = context | {
        "advanced_search_flag": is_advanced,
...
class AdvancedSearch(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        """
        return _search_post_helper(request, True)
...
class Search(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        When accessing the search page through post, run a search and display the results.
        """
        return _search_post_helper(request, False)
