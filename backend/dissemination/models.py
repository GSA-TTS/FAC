...
class MigrationChangeRecord(models.Model):
    ...
    findingtext = models.JSONField(blank=True, null=True)
    additionaluei = models.JSONField(blank=True, null=True)
    additionalein = models.JSONField(blank=True, null=True)
    finding = models.JSONField(blank=True, null=True)
    federalaward = models.JSONField(blank=True, null=True)
    captext = models.JSONField(blank=True, null=True)
    ...
    secondaryauditor = models.JSONField(blank=True, null=True)
