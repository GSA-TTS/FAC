...
CREATE INDEX IF NOT EXISTS fac_snapshot_db_corrective_action_plans_report_id_fad
	on public_data_v1_0_0.corrective_action_plans (report_id, fac_accepted_date);

CREATE INDEX IF NOT EXISTS fac_snapshot_db_corrective_action_plans_report_id_fad_frn
