...
BEGIN
  CREATE TABLE public_data_v1_0_0.general AS
    SELECT
      gen.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_general') AS seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.additional_eins AS
    SELECT 
      ein.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_additional_eins') AS seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.additional_ueis AS
    SELECT
      uei.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_additional_ueis') AS seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.corrective_action_plans AS
    SELECT
      cap.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_corrective_action_plans') as seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.federal_awards AS
    SELECT
      award.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_federal_awards') as seq,
      dg.report_id,
      dg.auditee_uei,
      dg.audit_year,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.findings AS
    SELECT
      finding.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_findings') as seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.findings_text AS
    SELECT
      ft.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_findings_text') as seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.notes_to_sefa AS
    SELECT
      note.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_notes_to_sefa') as seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.passthrough AS
    SELECT
      pass.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_passthrough') as seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.secondary_auditors AS
    SELECT
      sa.id as id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_secondary_auditors') as seq,
      gen.report_id,
      gen.auditee_uei,
      gen.audit_year,
      gen.fac_accepted_date,
...
BEGIN
  CREATE TABLE public_data_v1_0_0.combined AS
    SELECT
      dg.report_id,
      NEXTVAL('public_data_v1_0_0.seq_v1_0_0_combined') as seq,
      dfa.award_reference,
      df.reference_number,
    ...
    ORDER BY seq
    -- FIXME Do not leave this limit in place.
    LIMIT 1;
