...
create view api.vw_general as
    select gen.*, award.federal_agency_prefix, award.federal_award_extension, ga.*
...
create view api.vw_federal_award as
    select gen..uei, gen.ein, gen.fy_start_dt, gen.fy_end_dt, gen.audit_year, award.*
...
create view api.vw_finding as
    select gen..uei, gen.ein, gen.fy_start_dt, gen.fy_end_dt, gen.audit_year, 
