...
-- finding_text
---------------------------------------
create view api_v1_0_2.findings_text as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
-- additional_ueis
---------------------------------------
create view api_v1_0_2.additional_ueis as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
-- finding
---------------------------------------
create view api_v1_0_2.findings as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
-- federal award
---------------------------------------
create view api_v1_0_2.federal_awards as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
---------------------------------------
create view api_v1_0_2.corrective_action_plans as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
-- notes_to_sefa
---------------------------------------
create view api_v1_0_2.notes_to_sefa as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
-- passthrough
---------------------------------------
create view api_v1_0_2.passthrough as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
-- general
---------------------------------------
create view api_v1_0_2.general as
    select
...
---------------------------------------
create view api_v1_0_2.secondary_auditors as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
...
create view api_v1_0_2.additional_eins as
    select
        gen.report_id,
        gen.auditee_uei,
        gen.audit_year,
