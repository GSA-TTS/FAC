...
def search_resubmissions(general_results, params):
    """
    ...
    t0 = time.time()
    q = Q()
    resubmission_fields = params.get("resubmissions", "False")

    if "False" in resubmission_fields:
        q |= Q(
            resubmission_status__in=[
