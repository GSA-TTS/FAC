...
upload_mapping = {
    ...
    "cfda": {
        ...
        "FINDINGREFNUMS": ["CfdaInfo", "finding_ref_numbers"],
        ...
        "CFDAPROGRAMNAME": ["CfdaInfo", "agency_name"],
        "AWARDIDENTIFICATION": ["CfdaInfo", "award_identification"],
        "CFDA": ["CfdaInfo", "agency_cfda"],
    ...
    "findings": {
        ...
        "FINDINGSREFNUMS": ["Findings", "finding_ref_number"],
        "PRIORFINDINGREFNUMS": ["Findings", "prior_finding_ref_numbers"],
        "TYPEREQUIREMENT": ["Findings", "type_requirement"],
        "ELECAUDITSID": ["Findings", "audit_id"],
        "ELECAUDITFINDINGSID": ["Findings", "audit_findings_id"],
        "AUDITYEAR": ["Findings", "audit_year"],
        "DBKEY": ["Findings", "dbkey"],
    },
    "findingstext_formatted": {
        "CHARTSTABLES": ["FindingsText", "charts_tables"],
        "FINDINGREFNUMS": ["FindingsText", "finding_ref_number"],
        "SEQ_NUMBER": ["FindingsText", "seqence_number"],
    ...
    "notes": {
        ...
        "SEQ_NUMBER": ["Notes", "sequence_number"],
    ...
    "revisions": {
        ...
        "ELECRPTREVISIONID": ["Revisions", "revision_id"],
        ...
        "AUDITINFO_EXPLAIN": ["Revisions", "audit_info_explain"],
    ...
    "agency": {
        ...
        # "AGENCY": ["CfdaInfo", "agency_prior_findings_list"],
