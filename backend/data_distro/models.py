...
class General(models.Model):
    audit_type = models.CharField(
        "Type of Audit", max_length=40, description=docs.audit_type
    )
    ...
    auditee_contact = models.CharField(
        "Name of Auditee Contact", max_length=50, description=docs.auditee_contact
    )
    auditee_date_signed = models.DateField(
        "Date of Auditee signature", description=docs.auditee_date_signed
    )
    ...
    auditee_fax = models.PositiveBigIntegerField(
        "Auditee Fax Number (optional)", null=True, description=docs.auditee_fax
    )  # , max_length=10
    auditee_name = models.CharField(
        "Name of the Auditee", max_length=70, description=docs.auditee_name
    )
    ...
    auditee_phone = models.PositiveBigIntegerField(
        "Auditee Phone Number", description=docs.auditee_phone
    )  # , max_length=10
    auditee_title = models.CharField(
        "Title of Auditee Contact", max_length=40, description=docs.auditee_title
    )
    auditor_ein = models.IntegerField(
        "CPA Firm EIN (only available for audit years 2013 and beyond)",
        description=docs.auditor_ein,
    )  # , max_length=9
    ...
    cpa_city = models.CharField(
        "CPA City", max_length=30, description=docs.cpa_city_general
    )
    cpa_contact = models.CharField(
        "Name of CPA Contact", max_length=50, description=docs.cpa_contact_general
    )
    cpa_country = models.CharField(
        "CPA Country", max_length=6, null=True, description=docs.cpa_country
    )
    cpa_date_signed = models.DateField(
        "Date of CPA signature", description=docs.cpa_date_signed
    )
    cpa_email = models.CharField(
        "CPA email address",
        max_length=60,
        null=True,
        description=docs.cpa_email_general,
    )
    cpa_fax = models.PositiveBigIntegerField(
        "CPA fax number (optional) ", null=True, description=docs.cpa_fax_general
    )  # , max_length=10
    cpa_firm_name = models.CharField(
        "CPA Firm Name", max_length=64, description=docs.cpa_firm_name_general
    )
    ...
    cpa_phone = models.PositiveBigIntegerField(
        "CPA phone number", description=docs.cpa_phone_general
    )  # , max_length=10
    cpa_state = models.CharField(
        "CPA State", max_length=2, description=docs.cpa_state_general
    )
    cpa_street1 = models.CharField(
        "CPA Street Address", max_length=45, description=docs.cpa_street1_general
    )
    cpa_street2 = models.CharField(
        "CPA Street Address", max_length=45, null=True, description=docs.cpa_street2
    )
    cpa_title = models.CharField(
        "Title of CPA Contact", max_length=40, description=docs.cpa_title_general
    )
    cpa_zip_code = models.IntegerField(
        "CPA Zip Code", description=docs.cpa_zip_code_general
    )  # , max_length=9
    ...
    ein = models.IntegerField(
        "Primary Employer Identification Number", description=docs.ein_general
    )  # , max_length=9
    ein_subcode = models.IntegerField(
        "Subcode assigned to the EIN", null=True, description=docs.ein_subcode
    )  # , max_length=3
    ...
    fy_start_date = models.DateField(
        "Fiscal Year Start Date", null=True, description=docs.fy_start_date
    )
    ...
    oversight_agency = models.IntegerField(
        ...
        null=True,
        description=docs.oversight_agency,
    )  # , max_length=2
    period_covered = models.CharField(
        "Audit Period Covered by Audit", max_length=40, description=docs.period_covered
    )
    ...
    street1 = models.CharField(
        "Auditee Street Address", max_length=45, description=docs.street1
    )
    street2 = models.CharField(
        "Auditee Street Address", max_length=45, null=True, description=docs.street2
    )
    total_fed_expenditures = models.BigIntegerField(
        "Total Federal Expenditures", description=docs.total_fed_expenditures
    )  # , max_length=12
    type_of_entity = models.CharField(
        "Contact FAC for information", max_length=40, description=docs.type_of_entity
    )
    ...
    uei = models.CharField(
        "Unique Entity ID", max_length=12, description=docs.uei_general
    )
    zip_code = models.IntegerField(
        "Auditee Zipcode", description=docs.zip_code
    )  # , max_length=9
...
class CfdaInfo(models.Model):
    ...
    amount = models.BigIntegerField(
        "Amount Expended for the Federal Program", description=docs.amount
    )  # , max_length=12
    program_total = models.BigIntegerField(
        ...
        description=docs.program_total,
    )  # , max_length=12
    ...
    federal_program_name = models.CharField(
        "Name of Federal Program", max_length=300, description=docs.federal_program_name
    )
    ...
    cfda = models.CharField(
        "Federal Agency Prefix and Extension", max_length=52, description=docs.cfda
    )
    cluster_name = models.CharField(
        "The name of the cluster",
        max_length=75,
        null=True,
        description=docs.cluster_name,
    )
    ...
    findings = models.TextField(
        "Items on the Findings page", null=True, description=docs.findings
    )
...
class Findings(models.Model):
    modified_opinion = models.BooleanField(
        "Modified Opinion finding", null=True, description=docs.modified_opinion
    )
    other_non_compliance = models.BooleanField(
        "Other Noncompliance finding", null=True, description=docs.other_non_compliance
    )
    material_weakness = models.BooleanField(
        "Material Weakness finding",
        null=True,
        description=docs.material_weakness_findings,
    )
    ...
    other_findings = models.BooleanField(
        "Other findings", null=True, description=docs.other_findings
    )
    questioned_costs = models.BooleanField(
        "Questioned Costs", null=True, description=docs.questioned_costs_findings
    )
    ...
    finding_ref_nums = models.CharField(
        "Findings Reference Numbers",
        max_length=100,
        description=docs.finding_ref_nums_findings,
    )
    ...
    type_requirement = models.CharField(
        "Type Requirement Failure",
        max_length=40,
        description=docs.type_requirement_findings,
    )
    elec_audits_id = models.IntegerField(
        "FAC system generated sequence number used to link to Findings data between CFDA Info and Findings",
...
class Findingstext(models.Model):
    ...
    seq_number = models.IntegerField(
        ...
        description=docs.seq_number_findingstext,
    )  # , max_length=4
    text = models.TextField(
        "Content of the finding text", description=docs.text_findingstext
    )
    dbkey = models.CharField(
        "Audit Year and DBKEY (database key) combined make up the primary key.",
        max_length=40,
...
class Captext(models.Model):
    ...
    seq_number = models.IntegerField(
        "Order that the CAP text was reported", description=docs.seq_number_captext
    )  # , max_length=4
    text = models.TextField(
        "Content of the Corrective Action Plan (CAP)", description=docs.text_captext
    )
    dbkey = models.CharField(
        "Audit Year and DBKEY (database key) combined make up the primary key.",
        max_length=40,
...
class Notes(models.Model):
    ...
    fac_id = models.IntegerField(
        "Internal Unique Identifier for the record", description=docs.fac_id
    )  # , max_length=12
    report_id = models.IntegerField(
        "Internal Audit Report Id", description=docs.report_id
    )  # , max_length=12
    version = models.IntegerField(
        "Internal Version", description=docs.version
    )  # , max_length=4
    seq_number = models.IntegerField(
        "Order that the Note was reported", description=docs.seq_number_notes
    )  # , max_length=4
    note_index = models.IntegerField(
        "Display Index for the Note", description=docs.note_index
    )  # , max_length=4
...
class MultipleCpasInfo(models.Model):
    cpa_phone = models.PositiveBigIntegerField(
        "CPA phone number", null=True, description=docs.cpa_phone_multiplecpasinfo
    )  # , max_length=10
    cpa_fax = models.PositiveBigIntegerField(
        "CPA fax number (optional)",
        null=True,
        description=docs.cpa_fax_multiplecpasinfo,
    )  # , max_length=10
    cpa_state = models.CharField(
        "CPA State", max_length=2, description=docs.cpa_state_multiplecpasinfo
    )
    cpa_city = models.CharField(
        "CPA City", max_length=30, description=docs.cpa_city_multiplecpasinfo
    )
    cpa_title = models.CharField(
        "Title of CPA Contact",
        max_length=40,
        description=docs.cpa_title_multiplecpasinfo,
    )
    cpa_street1 = models.CharField(
        "CPA Street Address",
        max_length=45,
        description=docs.cpa_street1_multiplecpasinfo,
    )
    # no cpa_street2 ?
    cpa_zip_code = models.IntegerField(
        "CPA Zip Code", null=True, description=docs.cpa_zip_code_multiplecpasinfo
    )  # , max_length=9
    cpa_contact = models.CharField(
        "Name of CPA Contact",
        max_length=50,
        description=docs.cpa_contact_multiplecpasinfo,
    )
    cpa_email = models.CharField(
    ...
    cpa_firm_name = models.CharField(
        "CPA Firm Name", max_length=64, description=docs.cpa_firm_name_multiplecpasinfo
    )
    cpa_ein = models.IntegerField(
        "CPA Firm EIN (only available for audit years 2013 and beyond)",
        null=True,
        description=docs.cpa_ein,
    )  # , max_length=9
    dbkey = models.CharField(
        "Audit Year and DBKEY (database key) combined make up the primary key.",
        max_length=40,
...
class Revisions(models.Model):
    ...
    elec_report_revision_id = models.IntegerField(
        ...
        description=docs.elec_report_revision_id,
    )  # , max_length=12
...
class UeiInfo(models.Model):
    uei = models.CharField(
        ...
        max_length=12,
        description=docs.uei_ueiinfo,
    )
    uei_seq_num = models.IntegerField(
        "Order that UEI was reported on page 4 of SF-SAC", description=docs.uei_seq_num
    )  # , max_length=40
    dbkey = models.CharField(
        "Audit Year and DBKEY (database key) combined make up the primary key.",
        max_length=40,
...
class Agencies(models.Model):
    agency_cfda = models.IntegerField(
        ...
        description=docs.agency_cfda,
    )  # , max_length=2
    ein = models.IntegerField(
        "Employer Identification Number (EIN) of primary grantee",
        null=True,
        description=docs.ein_agencies,
    )  # , max_length=9
    dbkey = models.CharField(
        "Audit Year and DBKEY (database key) combined make up the primary key.",
        max_length=40,
...
class Passthrough(models.Model):
    passthrough_name = models.CharField(
        "Name of Pass-through Entity", max_length=70, description=docs.passthrough_name
    )
...
class EinInfo(models.Model):
    ein = models.IntegerField(
        "Multiple Employer Identification Numbers", description=docs.ein_eininfo
    )  # , max_length=9
...
class DunsInfo(models.Model):
    duns = models.IntegerField(
        ...
        description=docs.duns_dunsinfo,
    )  # , max_length=9
