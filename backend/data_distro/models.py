...
class Revisions(models.Model):
    ...
    #  it seems like this should not be null, but it is in the data
...
class Agencies(models.Model):
    ...
    # we can keep this if the codes change over time, otherwise we don't need the duplication
    audit_year = models.CharField(
        "Audit Year and DBKEY (database key) combined make up the primary key.",
        max_length=40,
...
class General(models.Model):
    ...
    # the sigmantures seem necessaoy?
