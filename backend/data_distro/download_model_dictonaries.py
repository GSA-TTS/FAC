...
mod_dict = {
    "General": {
        ...
        "reportrequired": ["Distribution to Federal Agency required?", "BooleanField"],
        "multipleueis": [
            "Identifies if the Submission Contains Multiple UEIs",
            "BooleanField",
        ],
        "auditeephone": ["Auditee Phone Number", "IntegerField"],
        "auditeefax": ["Auditee Fax Number (optional)", "IntegerField"],
        "cpaphone": ["CPA phone number", "IntegerField"],
        "cpafax": ["CPA fax number (optional)", "IntegerField"],
        "uei": ["Unique Entity ID", "CharField"],
        "totfedexpend": ["Total Federal Expenditures", "IntegerField"],
        "state": ["Auditee State", "CharField"],
        "cpastate": ["CPA State", "CharField"],
        "cogagency": [
        ...
        "cpaforeign": ["CPA Address (if international)", "CharField"],
        "einsubcode": ["Subcode assigned to the EIN", "IntegerField"],
        "city": ["Auditee City", "CharField"],
        "cpacity": ["CPA City", "CharField"],
        "auditeetitle": ["Title of Auditee Contact", "CharField"],
        "cpatitle": ["Title of CPA Contact", "CharField"],
        "street1": ["Auditee Street Address", "CharField"],
        "street2": ["Auditee Street Address", "CharField"],
        "cpastreet1": ["CPA Street Address", "CharField"],
        "cpastreet2": ["CPA Street Address", "CharField"],
        "zipcode": ["Auditee Zipcode", "IntegerField"],
        "cpazipcode": ["CPA Zip Code", "IntegerField"],
        "auditeecontact": ["Name of Auditee Contact", "CharField"],
        "auditeecertifyname": ["Name of Auditee Certifying Official", "CharField"],
        "auditeecertifytitle": ["Title of Auditee Certifying Official", "CharField"],
        "cpacontact": ["Name of CPA Contact", "CharField"],
        "entity_type": [
            "Self reported type of entity (i.e., States, Local Governments, Indian Tribes, Institutions of Higher Education, NonProfit)",
            "CharField",
        ],
        "cpacountry": ["CPA Country", "CharField"],
        "auditeeemail": ["Auditee Email address", "CharField"],
        "cpaemail": ["CPA email address", "CharField"],
        "cpafirmname": ["CPA Firm Name", "CharField"],
        "auditeename": ["Name of the Auditee", "CharField"],
        "auditeenametitle": ["Title of Auditee Certifying Official", "CharField"],
        "ein": ["Primary Employer Identification Number", "IntegerField"],
        "duns": ["Primary Data Universal Numbering System Number", "IntegerField"],
        "auditor_ein": [
    ...
    "CfdaInfo": {
        ...
        "findingrefnums": ["Findings Reference Numbers", "CharField"],
        "amount": ["Amount Expended for the Federal Program", "IntegerField"],
        "programtotal": [
        ...
        "passthroughamount": ["Amount passed through to subrecipients", "IntegerField"],
        "loanbalance": [
            "The loan or loan guarantee (loan) balance outstanding at the end of the audit period.  A response of ‘N/A’ is acceptable.",
            "CharField",
        ],
        "federalprogramname": ["Name of Federal Program", "CharField"],
        "cfdaprogramname": [
        ...
        "cfda": ["Federal Agency Prefix and Extension", "IntegerField"],
        "clustername": ["The name of the cluster", "CharField"],
        "stateclustername": ["The name of the state cluster", "CharField"],
        "otherclustername": [
    ...
    "Findings": {
        ...
        "significantdeficiency": ["Significant Deficiency finding", "BooleanField"],
    ...
    "Findingstext": {
        ...
        "findingrefnums": ["Audit Finding Reference Number", "CharField"],
        "seq_number": ["Order that the findings text was reported", "IntegerField"],
    ...
    "Captext": {
        ...
        "findingrefnums": ["Audit Finding Reference Number", "CharField"],
        "seq_number": ["Order that the CAP text was reported", "IntegerField"],
    ...
    "Notes": {
        "type_id": ["Note Type", "CharField"],
        "id": ["Internal Unique Identifier for the record", "IntegerField"],
        "reportid": ["Internal Audit Report Id", "IntegerField"],
        "": ["'-continued", ""],
        "version": ["Internal Version", "IntegerField"],
        "seq_number": ["Order that the Note was reported", "IntegerField"],
        "note_index": ["Display Index for the Note", "IntegerField"],
        "content": ["Content of the Note", "TextField"],
        "title": ["Note Title", "CharField"],
        "dbkey": [
            "Audit Year and DBKEY (database key) combined make up the primary key.",
            "CharField",
        ],
    ...
    "MultipleCpasInfo": {
        ...
        "cpazipcode": ["CPA Zip Code", "IntegerField"],
        "cpacontact": ["Name of CPA Contact", "CharField"],
        "cpaemail": ["CPA email address (optional)", "CharField"],
        "cpafirmname": ["CPA Firm Name", "CharField"],
        "cpaein": [
            "CPA Firm EIN (only available for audit years 2013 and beyond)",
            "IntegerField",
    ...
    "UeiInfo": {
        "uei": ["Multiple Unique Entity Identifier Numbers", "CharField"],
        "ueiseqnum": [
    ...
    "Passthrough": {
        "passthroughname": ["Name of Pass-through Entity", "CharField"],
        "passthroughid": [
    ...
    "EinInfo": {
        "ein": ["Multiple Employer Identification Numbers", "IntegerField"],
        "einseqnum": [
    ...
    "DunInfo": {
        "duns": ["Multiple Data Universal Numbering System Numbers", "IntegerField"],
        "dunseqnum": [
...
field_transforms = [
    ...
    {"MULTIPLEEINS": "multipleeins"},
    {"MULTIPLEDUNS": "multipleduns"},
    {"MULTIPLE_CPAS": "multiple_cpas"},
    {"SP_FRAMEWORK_REQUIRED": "sp_framework_required"},
    {"GOINGCONCERN": "goingconcern"},
    {
        "REPORTABLECONDITION/SIGNIFICANTDEFICIENCY": "reportablecondition/significantdeficiency"
    },
    {"MATERIALWEAKNESS": "materialweakness"},
    {"MATERIALNONCOMPLIANCE": "materialnoncompliance"},
    {"DUP_REPORTS": "dup_reports"},
    {"LOWRISK": "lowrisk"},
    {
        "REPORTABLECONDITION/SIGNIFICANTDEFICIENCY_MP": "reportablecondition/significantdeficiency_mp"
    },
    ...
    {"MULTIPLEUEIS": "multipleueis"},
    {"R&D": "r&d"},
    {"LOANS": "loans"},
    {"ARRA": "arra"},
    {"DIRECT": "direct"},
    {"PASSTHROUGHAWARD": "passthroughaward"},
    {"MAJORPROGRAM": "majorprogram"},
    {"MODIFIEDOPINION": "modifiedopinion"},
    {"OTHERNONCOMPLIANCE": "othernoncompliance"},
    {"SIGNIFICANTDEFICIENCY": "significantdeficiency"},
    {"OTHERFINDINGS": "otherfindings"},
    {"REPEATFINDING": "repeatfinding"},
    {"CHARTSTABLES": "chartstables"},
    {"TYPE_ID": "type_id"},
    {"AUDITEEPHONE": "auditeephone"},
    {"AUDITEEFAX": "auditeefax"},
    {"CPAPHONE": "cpaphone"},
    {"CPAFAX": "cpafax"},
    {"FINDINGREFNUMS": "findingrefnums"},
    {"PRIORFINDINGREFNUMS": "priorfindingrefnums"},
    {"FINDINGS": "findings"},
    {"UEI": "uei"},
    {"AMOUNT": "amount"},
    {"PROGRAMTOTAL": "programtotal"},
    {"CLUSTERTOTAL": "clustertotal"},
    {"PASSTHROUGHAMOUNT": "passthroughamount"},
    {"LOANBALANCE": "loanbalance"},
    {"ID": "id"},
    {"REPORTID": "reportid"},
    {"ELECRPTREVISIONID": "elecrptrevisionid"},
    {"TOTFEDEXPEND": "totfedexpend"},
    {"FEDERALAWARDS": "federalawards"},
    {"GENINFO_EXPLAIN": "geninfo_explain"},
    {"FEDERALAWARDS_EXPLAIN": "federalawards_explain"},
    {"NOTESTOSEFA_EXPLAIN": "notestosefa_explain"},
    {"AUDITINFO_EXPLAIN": "auditinfo_explain"},
    {"FINDINGS_EXPLAIN": "findings_explain"},
    {"FINDINGSTEXT_EXPLAIN": "findingstext_explain"},
    {"CAP_EXPLAIN": "cap_explain"},
    {"OTHER_EXPLAIN": "other_explain"},
    {"STATE": "state"},
    {"CPASTATE": "cpastate"},
    {"COGAGENCY": "cogagency"},
    {"OVERSIGHTAGENCY": "oversightagency"},
    {"AGENCYCFDA": "agencycfda"},
    # {'': ''},
    {"AUDITINFO": "auditinfo"},
    {"CPAFOREIGN": "cpaforeign"},
    {"EINSUBCODE": "einsubcode"},
    {"CITY": "city"},
    {"CPACITY": "cpacity"},
    {"FEDERALPROGRAMNAME": "federalprogramname"},
    {"CFDAPROGRAMNAME": "cfdaprogramname"},
    {"VERSION": "version"},
    {"SEQ_NUMBER": "seq_number"},
    {"NOTE_INDEX": "note_index"},
    {"AUDITEETITLE": "auditeetitle"},
    {"CPATITLE": "cpatitle"},
    {"CONTENT": "content"},
    {"STREET1": "street1"},
    {"STREET2": "street2"},
    {"CPASTREET1": "cpastreet1"},
    {"CPASTREET2": "cpastreet2"},
    {"ZIPCODE": "zipcode"},
    ...
    {"CPAEMAIL": "cpaemail"},
    {"CPAFIRMNAME": "cpafirmname"},
    {"OTHER": "other"},
    {"PASSTHROUGHNAME": "passthroughname"},
    {"PASSTHROUGHID": "passthroughid"},
    {"AUDITEENAME": "auditeename"},
    {"AUDITEENAMETITLE": "auditeenametitle"},
    {"CLUSTERNAME": "clustername"},
    {"STATECLUSTERNAME": "stateclustername"},
    ...
    {"FYENDDATE": "fyenddate"},
    {"AUDITEEDATESIGNED": "auditeedatesigned"},
    {"CPADATESIGNED": "cpadatesigned"},
    {"INITIAL DATE RECEIVED": "initialdatereceived"},
    {"FORM DATE RECEIVED": "formdatereceived"},
    {"COMPONENT DATE RECEIVED": "componentdatereceived"},
    {"COMPLETED_ON": "completed_on"},
    {"PREVIOUS_COMPLETED_ON": "previous_completed_on"},
    {"FAC ACCEPTED DATE": "facaccepteddate"},
    {"EINSEQNUM": "einseqnum"},
    {"DUNSEQNUM": "dunseqnum"},
    {"UEISEQNUM": "ueiseqnum"},
