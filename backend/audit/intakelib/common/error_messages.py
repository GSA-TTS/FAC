messages = {
    ...
    "check_finding_reference_invalid": "Finding references must be in the format <b>20##-###</b> where the first four digits are a year greater after 2010, for example, <b>2019-001, 2019-002</b>",
