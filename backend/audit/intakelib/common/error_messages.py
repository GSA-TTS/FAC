messages = {
    ...
    "check_passthrough_names_and_ids_uniqueness": "Duplicate passthrough entity name and identifying number found: ({}, {})",
    ...
    "check_blank_space_in_passthrough_names": "A blank space cannot serve as a substitute for a passthrough entity name",
    "check_blank_space_in_passthrough_identifying_numbers": "A blank space cannot serve as a substitute for a passthrough entity identifying number",
