...
class CheckRefNumberInFindingsTextTests(TestCase):
    ...
    def test_references_direct_match(self):
        ...
        errors = check_ref_number_in_findings_text(audit_validation_shape(audit))
