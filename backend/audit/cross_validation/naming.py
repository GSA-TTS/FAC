...
SECTION_NAMES = {
    ...
    "resubmission_meta": SectionBabelFish(
        all_caps="RESUBMISSION_META",
        camel_case=FORM_SECTIONS.RESUBMISSION_META,
        friendly="Resubmission Metadata",
        friendly_title="Resubmission metadata",
        reverse_url_for_file_upload="ResubmissionActionEditView:ResubmissionActionEdit",
        reverse_url_for_file_deletion=None,
        snake_case="resubmission_meta",
        url_tail="resubmission-meta",
        workbook_number=None,
        submission_event=SubmissionEvent.EventType.RESUBMISSION_META_UPDATED,
        deletion_event=None,
        audit_translation=None,
    ),
