...
class TestAuditValidationWaiverAdmin(TestCase):
...
class TestDeleteFlaggedRecordsAdminAction(TestCase):
    ...
    def test_delete_flagged_records_skips_non_flagged(
        self, mock_remove_workbook_artifacts, mock_remove_singleauditreport_pdf
    ):
