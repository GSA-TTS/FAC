    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_usa_based",
                    models.BooleanField(verbose_name="Is USA Based"),
                ),
                (
                    "uei",
                    models.CharField(
                ...
                (
                    ...
                    models.BooleanField(
                        null=True, verbose_name="Attestation: EIN Not an SSN"
                    ),
                ),
                (
                    "multiple_eins_covered",
                    models.BooleanField(
                        null=True, verbose_name="Multiple EINs covered"
                    ),
                ),
                (
                    "multiple_ueis_covered",
                    models.BooleanField(
                        null=True, verbose_name="Multiple UEIs covered"
                    ),
                ),
                ...
                (
                    "auditor_ein",
                    models.CharField(
                        max_length=12, null=True, verbose_name="Auditor EIN"
                    ),
                ),
                (
