...
def _fix_addl_award_identification(cfdas, dbkey):
...
def _fix_passthroughs(cfdas, dbkey):
...
def generate_federal_awards(dbkey, outfile):
    ...
    addls = _fix_addl_award_identification(cfdas, dbkey)
    ...
    (passthrough_names, passthrough_ids) = _fix_passthroughs(cfdas, dbkey)
