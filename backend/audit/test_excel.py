...
class SecondaryAuditorsExcelTests(SimpleTestCase):
    ...
    def test_secondary_auditors_checking(self):
        ...
        test_cases = [
            ...
            ("secondary_auditor_address_street", True),
            ("secondary_auditor_address_city", 0),
            ("secondary_auditor_address_state", "Of Mind"),
            ("secondary_auditor_address_zipcode", "91919999"),
