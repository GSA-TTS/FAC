class Util:
    ...
    def remove_extra_fields(general_information_data):
        ...
        if general_information_data["auditor_country"] == "USA":
        ...
        elif general_information_data["auditor_country"] != "USA":
        ...
        if general_information_data["audit_period_covered"] != "other":
