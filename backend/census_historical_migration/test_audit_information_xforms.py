...
class TestXformFrameworkBasis(SimpleTestCase):
    def test_valid_bases(self):
        ...
        self.assertEqual(xform_framework_basis_v2("cash"), "cash_basis")
        self.assertEqual(xform_framework_basis_v2("contractual"), "contractual_basis")
        self.assertEqual(xform_framework_basis_v2("regulatory"), "regulatory_basis")
        self.assertEqual(xform_framework_basis_v2("tax"), "tax_basis")
        self.assertEqual(xform_framework_basis_v2("other"), "other_basis")

    def test_basis_with_upper_cases(self):
        """Test that the function returns the correct results for each basis in upper cases."""
        self.assertEqual(xform_framework_basis_v2("CASH"), "cash_basis")
        self.assertEqual(
            xform_framework_basis_v2("OTHER"),
            "other_basis",
        )
        self.assertEqual(xform_framework_basis_v2("REGULATORY"), "regulatory_basis")
        self.assertEqual(xform_framework_basis_v2("TAX"), "tax_basis")
        self.assertEqual(
            xform_framework_basis_v2("CONTRACTUAL"),
            "contractual_basis",
        )
    ...
    def test_invalid_basis(self):
        ...
        with self.assertRaises(DataMigrationError):
            xform_framework_basis_v2("equity")
