...
class Cfda(models.Model):
    ...
    ein = models.BigIntegerField(db_column='EIN', blank=True, null=True)  # Field name made lowercase.
    ...
    rd = models.FloatField(db_column='RD', blank=True, null=True)  # Field name made lowercase.
    ...
    programtotal = models.FloatField(db_column='PROGRAMTOTAL', blank=True, null=True)  # Field name made lowercase.
    clustertotal = models.FloatField(db_column='CLUSTERTOTAL', blank=True, null=True)  # Field name made lowercase.
    direct = models.TextField(db_column='DIRECT', blank=True, null=True)  # Field name made lowercase.
    passthroughaward = models.TextField(db_column='PASSTHROUGHAWARD', blank=True, null=True)  # Field name made lowercase.
    passthroughamount = models.FloatField(db_column='PASSTHROUGHAMOUNT', blank=True, null=True)  # Field name made lowercase.
    ...
    typerequirement = models.FloatField(db_column='TYPEREQUIREMENT', blank=True, null=True)  # Field name made lowercase.
    qcosts2 = models.FloatField(db_column='QCOSTS2', blank=True, null=True)  # Field name made lowercase.
    findings = models.FloatField(db_column='FINDINGS', blank=True, null=True)  # Field name made lowercase.
    findingrefnums = models.FloatField(db_column='FINDINGREFNUMS', blank=True, null=True)  # Field name made lowercase.
    arra = models.FloatField(db_column='ARRA', blank=True, null=True)  # Field name made lowercase.
    loans = models.TextField(db_column='LOANS', blank=True, null=True)  # Field name made lowercase.
    loanbalance = models.FloatField(db_column='LOANBALANCE', blank=True, null=True)  # Field name made lowercase.
    findingscount = models.FloatField(db_column='FINDINGSCOUNT', blank=True, null=True)  # Field name made lowercase.
    elecauditsid = models.FloatField(db_column='ELECAUDITSID', blank=True, null=True)  # Field name made lowercase.
